 <x-main>
     ...
     <div class="px-4 py-5 my-5 text-center">
         <h1 class="display-5 fw-bold text-body-emphasis">Chi sono io</h1>
         <div class="col-lg-6 mx-auto">
             <x-navbar brand="ciao"></x-navbar>
             <p class="lead mb-5">Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s
